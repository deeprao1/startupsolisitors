(function ($) {
  ...
  */
  ...
  function initSwiper() {
   ...
   if ($.exists(".dedicated-services-slider")) {
      const swiper = new Swiper(".dedicated-services-slider", {
        loop: true,
        speed: 1000,
        autoplay: {
          delay: 2500,
        ...
        navigation: {
          nextEl: ".dedicated-services-next-btn",
          prevEl: ".dedicated-services-prev-btn",
        },
        breakpoints: {
          0: {
            slidesPerView: 1,
